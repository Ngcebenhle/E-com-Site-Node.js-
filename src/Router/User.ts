...
class UserRouter {
  ...
  getRoutes() {
    ...
    this.router.get(
      "/otpLogIn",
      userValidator.otpLogIn(), 
      globalMiddleWare.checkError,
      UserController.authonticateUserViaPhoneNumber
    );

    this.router.get(
      "/registerUserViaPhone",
      userValidator.registerUserViaPhoneNumber(), 
      globalMiddleWare.checkError,
      UserController.registerUserViaPhoneNumber
    );
  ...
  patchRoutes() {
    ...
    this.router.patch(
      ...
      globalMiddleWare.auth,
      userValidator.verifyCustomerProfile(),
      globalMiddleWare.checkError,
